...
func (c *payloadProviderServiceClient) TokenPayload(ctx context.Context, in *TokenPayloadRequest, opts ...grpc.CallOption) (*TokenPayloadResponse, error) {
	...
	err := c.cc.Invoke(ctx, PayloadProviderService_TokenPayload_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *payloadProviderServiceClient) Close(ctx context.Context, in *CloseRequest, opts ...grpc.CallOption) (*CloseResponse, error) {
	...
	err := c.cc.Invoke(ctx, PayloadProviderService_Close_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPayloadProviderServiceServer must be embedded to have
...
func (UnimplementedPayloadProviderServiceServer) testEmbeddedByValue() {}
...
func RegisterPayloadProviderServiceServer(s grpc.ServiceRegistrar, srv PayloadProviderServiceServer) {
	// If the following call pancis, it indicates UnimplementedPayloadProviderServiceServer was
...
var PayloadProviderService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "user_payload_provider/grpc/payload_provider/payload_provider.proto",
}
