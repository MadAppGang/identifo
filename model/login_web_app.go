...
type LoginWebAppSettings struct {
	...
	ConfirmEmailURL  string `json:"confirm_email_url,omitempty"`
	ErrorURL         string `json:"error_url,omitempty"`
	TFADisableURL    string `json:"tfa_disable_url,omitempty"`
	TFAResetURL      string `json:"tfa_reset_url,omitempty"`
