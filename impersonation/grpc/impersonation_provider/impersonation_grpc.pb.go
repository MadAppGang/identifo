...
func (c *impersonationProviderClient) CanImpersonate(ctx context.Context, in *CanImpersonateRequest, opts ...grpc.CallOption) (*CanImpersonateResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpersonationProvider_CanImpersonate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *impersonationProviderClient) Close(ctx context.Context, in *CloseRequest, opts ...grpc.CallOption) (*CloseResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpersonationProvider_Close_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedImpersonationProviderServer must be embedded to have
...
func (UnimplementedImpersonationProviderServer) testEmbeddedByValue()                               {}
...
func RegisterImpersonationProviderServer(s grpc.ServiceRegistrar, srv ImpersonationProviderServer) {
	// If the following call pancis, it indicates UnimplementedImpersonationProviderServer was
