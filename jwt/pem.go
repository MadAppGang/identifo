...
func LoadPrivateKeyFromPEM(file string, alg TokenServiceAlgorithm) (interface{}, error) {
...
func LoadPublicKeyFromPEM(file string, alg TokenServiceAlgorithm) (interface{}, error) {
...
func LoadPublicKeyFromString(s string, alg TokenServiceAlgorithm) (interface{}, error) {
	var publicKey interface{}
	var err error
